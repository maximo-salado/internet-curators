...
export default function NavDrawer({ open, onClose }: NavDrawerProps) {
  ...
  return (
    <>
      ...
      <div
        ref={drawerRef}
        className={`fixed inset-y-0 left-0 z-50 w-full max-w-sm border-r border-zinc-800 bg-zinc-900 shadow-2xl overflow-y-auto transition-transform duration-300 ease-out ${
          ...
          <div className="px-5 pt-6 pb-4">
            <div className="flex items-center justify-between">
              ...
              <button
                type="button"
                onClick={onClose}
                className="flex h-8 w-8 items-center justify-center rounded-full text-zinc-400 transition-colors hover:bg-zinc-800 hover:text-zinc-200"
