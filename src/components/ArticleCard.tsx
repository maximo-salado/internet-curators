        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className={`rounded px-1.5 py-0.5 text-xs transition-colors ${
              vote === 1 ? "text-green-400" : "text-zinc-600 hover:text-zinc-400"
            }`}
          >
            ▲
          </button>
          <button
            onClick={() => handleVote(-1)}
            className={`rounded px-1.5 py-0.5 text-xs transition-colors ${
              vote === -1 ? "text-red-400" : "text-zinc-600 hover:text-zinc-400"
            }`}
          >
            ▼
          </button>
          ...
          <button
            ...
            className="rounded px-1.5 py-0.5 text-xs text-zinc-600 hover:text-red-400 transition-colors"
          >
            Remove
          </button>
          <button
      ...
      {confirming && (
        <div className="mt-3 rounded-md border border-zinc-700 bg-zinc-800 p-3">
          ...
          <div className="flex gap-2">
            <button
              onClick={confirming === "hide" ? handleHide : handleRemoveSource}
